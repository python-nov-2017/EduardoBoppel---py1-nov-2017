...
class CallCenter(object):
    ...
    def __repr__(self):
        return "<CallCenter Object, calls: {}, queue: {}>".format(self.calls, self.queue)
...
class Call(object):
    ...
    def __repr__(self):
        return "<Call object, id: {}, name: {}, number: {}, time: {}, reason: {}>".format(self.id, self.name, self.number, self.time, self.reason)
